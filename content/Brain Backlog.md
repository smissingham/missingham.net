...
updated: 2025-03-03T11:02
---
Where I list things that I want/intend to read, watch, research or otherwise consume 
___
# Research Subjects
## PKM
- [x] [Obsidian MeshAI Plugin](https://github.com/chasebank87/mesh-ai)
- [x] [Obsidian Relay](https://obsidian.md/plugins?search=system3-relay)
## Technologies
- [ ] Basic Python Modelling Pipelines
- [ ] Database, Data Warehouse, Data Lake & Data Lakehoues
- [ ] DataFrame Cheat Sheets
- [ ] [HuggingFace SmolAgents](https://github.com/huggingface/smolagents/tree/main)
- [ ] Minds DB
...
- [x] [DuckDB](https://duckdb.org/why_duckdb)
- [x] [Fabric - LLM Prompt Library](https://github.com/danielmiessler/fabric)
- [x] [Nix OS](https://nixos.org/)
- [x] [Polars](https://docs.pola.rs/)
- [x] Using [Ollama](https://ollama.com/library) + [continue.dev](https://www.continue.dev/) open source tools for free AI code-completion
## Tools
- [Local AI Note Taker](https://github.com/Zackriya-Solutions/meeting-minutes)
# Specific Content
## Books
...
## Youtube Videos
- [x] [NixOS From the Ground Up](https://www.youtube.com/watch?v=5D3nUU1OVx8)
- [x] [NixVim](https://www.youtube.com/watch?v=b641h63lqy0)
- [x] [NVChad](https://www.youtube.com/watch?v=Mtgo-nP_r8Y)
- [x] [Tmux](https://www.youtube.com/watch?v=DzNmUNvnB04)
## Articles / Blog
- [ ] [Martin Fowler - GenAI Patterns](https://martinfowler.com/articles/gen-ai-patterns/)
# Notes / Articles to Make
